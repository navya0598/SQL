...
SELECT employee_id EMP_ID, first_name FN,last_name LN FROM EMPLOYEES;
SELECT employee_id EMP_ID, first_name FN,last_name LN,SALARY+300 SAL FROM EMPLOYEES;
...
/**********DISTINCT COMMAND EXAMPLES*********/
SELECT DISTINCT department_id FROM EMPLOYEES;
SELECT DISTINCT * FROM EMPLOYEES;

/**********LOGICAL (AND OR NOT ) COMMAND EXAMPLES*********/
...
/**********BETWEEN AND IN COMMAND EXAMPLES*********/
SELECT * FROM EMPLOYEES WHERE SALARY BETWEEN 10000 AND 12000;
SELECT * FROM EMPLOYEES WHERE SALARY NOT BETWEEN 10000 AND 12000;

SELECT * FROM EMPLOYEES WHERE SALARY IN (3400,3000,2500,12000);
SELECT * FROM EMPLOYEES WHERE SALARY NOT IN (3400,3000,2500,12000);
...
SELECT TRIM('        WELCOME          ');
SELECT TRIM("Z" FROM "ZZORZACLEZZ");
SELECT INSTR("NAVYA","A");
...
SELECT TRUNCATE(13567643,-3);
SELECT GREATEST(30,458,4648);
SELECT LEAST(30,458,4648);
...
SELECT NOW();
SELECT SYSDATE();
SELECT month("2019-05-13");
SELECT YEAR("2019-05-13");
SELECT day("2019-05-13");
